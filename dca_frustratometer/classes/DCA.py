...
class PottsModel(Frustratometer):
    ...
    def __init__(self, pdb_file:str,chain:str=None,sequence:str= None,sequence_cutoff:typing.Union[float, None] = None,distance_cutoff:typing.Union[float, None] = None):
