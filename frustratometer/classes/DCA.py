...
class DCA(Frustratometer):
    ...
    def from_pfam_alignment(cls,pdb_structure : object,
                            alignment_output_file: Union[Path,str],
                            PFAM_ID: str = None,
                            DCA_format : str = "plmDCA",
                            sequence_cutoff: Union[float, None] = None,
                            distance_cutoff: Union[float, None] = None)->object:
        """
        Generate DCA object from a downloaded PFAM alignment file that will be used to generate a Potts Model file.

        Parameters
        ----------
        pdb_structure : object
            Structure object generated by Structure class
        alignment_output_file : Path or str
            File name of generated alignment file. The generated alignment file will be in Fasta format.
        PFAM_ID :  str
        ...
        self._alignment_file=pfam.download_aligment(self.PFAM_ID,self.alignment_output_file)
        self._filtered_alignment_file=filter.filter_alignment(self.alignment_file,self.alignment_output_file)
